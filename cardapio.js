  ...
  secoes: [
    {
      ...
      itens: [
        ["Sardella (porção de 100g)", 
         ...
         ["Pote de vidro"], 
         "Tradicional antepasto italiano."],
        ...
        ["Melanzane Sottolio (porção de 100g)", 
         ...
         ["Pote de vidro"], 
         "Berinjela em conserva italiana."],
